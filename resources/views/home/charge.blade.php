                    ...
                    <form name="checkout" class="checkout ecommerce-checkout row" enctype="multipart/form-data" method="POST"
                        ...
                        <div class="col-md-4">
                            <div class="order-review-wrap ecommerce-checkout-review-order" id="order_review">
                                <h2 class="heading uppercase bottom-line full-grey">Your Charge</h2>
                                <table class="table shop_table ecommerce-checkout-review-order-table">
                                    <tbody>
                                        <tr class="order-total">
                                            <th><strong>Charge Total</strong></th>
                                            <td>
                                                <strong><span class="amount">Rp.
                                                        {{ number_format($orders->charge) }}</span></strong>
                                                <input type="hidden" name="jumlah" value="{{ $orders->charge }}">
                                ...
                                <div id="payment" class="ecommerce-checkout-payment">
                                    ...
                                    <div class="form-row place-order">
                                        <input type="submit" name="ecommerce_checkout_place_order"
                                            class="btn btn-lg btn-dark" id="place_order" value="Place Charge">
                                    </div>
                                </div>
                            </div>
