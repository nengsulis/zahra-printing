    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/sbadmin2/index.html">
                ...
                <div class="sidebar-brand-text mx-3">Zahra Printing</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseContent" class="collapse" aria-labelledby="headingContent"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/gateway">Gateway</a>
                        ...
                        <a class="collapse-item" href="/produk">Products</a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; E-commerce Zahra 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
